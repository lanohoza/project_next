...
@Builder
@Entity
@Table(name = "tco_001_establishment_conditions")
@EntityListeners(AuditingEntityListener.class)

public class TCO001EstablishmentCondition {
	@Id
	...
	TCO001EstablishmentConditionSubjectType subjectType;
	@Column(name = "number")
	...
	public enum TCO001EstablishmentConditionSubjectType {
		all, one, empty
	}
}
